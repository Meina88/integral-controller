...
"                <div class='fgs'><label>Vel. extrusi&oacute;n (m/min)</label><input id='f_belt' type='number' step='0.1' value='8.0'/></div>"
"              </div>"
...
"            </div>"
"          </div>"
"          <div style='display:flex;justify-content:center;gap:8px;margin-top:16px;padding-top:12px;border-top:1px solid var(--brd)'>"
...
/* --- PROFILES --- */
"let allCodes=[],curCode=null,isNew=false,_screw=25;"
...
"    process:{screw:_screw,target_speed_vfd_rpm:parseInt(document.getElementById('f_vfd').value),target_speed_belt_m_min:parseFloat(document.getElementById('f_belt').value)},"
