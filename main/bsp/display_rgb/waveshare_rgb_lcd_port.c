 ...
 */
static void gpio_init_output_reset(void)
{
...
/**
 * @brief Initialize RGB LCD and touch, then bind them to LVGL port
 */
esp_err_t waveshare_esp32_s3_rgb_lcd_init(void)
{
    ...
    ESP_LOGI(TAG, "Initialize touch reset GPIO");
    gpio_init_output_reset();
