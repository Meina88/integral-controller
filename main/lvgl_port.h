...
/* =========================
   BUFFER CONFIG (LVGL 9)
   ========================= */

/*
 * Memory type:
 * - MALLOC_CAP_SPIRAM → PSRAM (más capacidad)
 * - MALLOC_CAP_INTERNAL → SRAM (más rápido)
 */
#define LVGL_PORT_BUFFER_MALLOC_CAPS (MALLOC_CAP_DMA | MALLOC_CAP_SPIRAM)

/*
 * Altura del buffer parcial
 * (ej: 40–100 líneas es típico para ESP32-S3)
 */
...
/**
 * @brief Notify VSYNC (optional sync with RGB panel)
 */
