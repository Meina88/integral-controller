...
lv_obj_t *screen_config_datetime_create(lv_obj_t *parent)
{
    ...
    lv_label_set_text(title, "CONFIGURACION RTC");
    ...
    lv_obj_set_style_bg_color(ta_date, lv_color_hex(0x2A313A), 0);
    lv_obj_set_style_bg_opa(ta_date, LV_OPA_COVER, 0);
    lv_obj_set_style_border_width(ta_date, 0, 0);
    lv_obj_set_style_text_color(ta_date, lv_color_white(), 0);
    lv_obj_set_style_text_font(ta_date, &lv_font_montserrat_24, 0);
    lv_obj_set_style_pad_left(ta_date, 18, 0);
    ...
    lv_obj_set_style_bg_color(ta_time, lv_color_hex(0x2A313A), 0);
    lv_obj_set_style_bg_opa(ta_time, LV_OPA_COVER, 0);
    lv_obj_set_style_border_width(ta_time, 0, 0);
    lv_obj_set_style_text_color(ta_time, lv_color_white(), 0);
    lv_obj_set_style_text_font(ta_time, &lv_font_montserrat_24, 0);
    lv_obj_set_style_pad_left(ta_time, 18, 0);
    ...
    lv_obj_set_style_bg_grad_color(btn, lv_palette_darken(LV_PALETTE_BLUE, 2), 0);
